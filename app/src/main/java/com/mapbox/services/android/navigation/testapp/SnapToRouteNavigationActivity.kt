...
class SnapToRouteNavigationActivity : AppCompatActivity(), OnMapReadyCallback,
    ...
    override fun onMapReady(mapboxMap: MapboxMap) {
        ...
        mapboxMap.setStyle("asset://style.json") { style ->
    ...
    private fun calculateRouteAndStartNavigation() {
        val navigationRouteBuilder = NavigationRoute.builder(this).apply {
            ...
            this.origin(Point.fromLngLat(58.403278369646316,37.896426900299126))
            this.addWaypoint(Point.fromLngLat(58.37701126780031,37.87979852793514))
            this.destination(Point.fromLngLat(58.37701126780031,37.87979852793514))
